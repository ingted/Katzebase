...
type private FieldBuilder with
    member fb.SetProtoMemberAttribute(tag : int) =
        printfn "SetProtoMemberAttribute with tag: %d" tag
...
let mutable private uniqueNameCounter = 1000L
...
let private emitUnionSurrogateWithTag (surrogateModule: ModuleBuilder) (unionType: Type) =
    ...
    printfn "[emitUnionSurrogateWithTag] SetProtoMemberAttribute 1, type: %s" unionType.Name
        ...
        for caseInfo in FSharpType.GetUnionCases(unionType, true) ->
            ...
            let caseData =
                ...
                | caseFields ->
                    ...
                    printfn "[emitUnionSurrogateWithTag] SetProtoMemberAttribute 2 + caseInfo.Tag (%d), type: %s" caseInfo.Tag unionType.Name

...
namespace NTDLS.Katzebase.Management.Classes
{
    internal class EditorFactory
    {
...
#if DEBUG
        private static string sqlHighlighter => @"..\..\..\..\@Installers\Highlighters\KBS.xshd";
#else
        ...
        public TabFilePage Create(string serverHost, int serverPort, string username, string passwordHash, string tabText)
        {
            ...
            var tabFilePage = new TabFilePage(TabControlParent, serverHost, serverPort, username, passwordHash, tabText, editor)
            {
                //..
            };
